...
#            state.valid = np.mean(resvalid[0] + resvalid[1])
            resvalid = RankingScoreRelIdx(rankrelfunc, validlidx, validridx, validoidx, 0)
            ...
            restrain = RankingScoreRelIdx(rankrelfunc, trainlidx, trainridx, trainoidx, 0)
...
#                state.besttest = np.mean(restest[0] + restest[1])
                restest = RankingScoreRelIdx(rankrelfunc, testlidx, testridx, testoidx, 0)
